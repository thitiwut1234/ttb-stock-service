...
### Insert: `PRODUCT`
```sql
INSERT INTO PRODUCT (PRODUCT_CODE, PRODUCT_NAME, PRODUCT_PRICE, ACTIVE, CREATE_BY, UPDATE_BY)
VALUES
    ('PROD-001', 'Apple iPhone 15 Pro 128GB', 39900, true, 'SYSTEM', 'SYSTEM'),
    ('PROD-002', 'Samsung Galaxy S24 Ultra 256GB', 43900, true, 'SYSTEM', 'SYSTEM'),
    ('PROD-003', 'Sony WH-1000XM5 Wireless Headphones', 13900, true, 'SYSTEM', 'SYSTEM'),
    ('PROD-004', 'Logitech MX Master 3S Mouse', 3690, true, 'admin', 'admin'),
    ('PROD-005', 'Keychron K2 V2 Wireless Keyboard', 3290, true, 'admin', 'admin'),
    ('PROD-006', 'Dell UltraSharp 27" 4K Monitor (U2723QE)', 19900, true, 'SYSTEM', 'SYSTEM'),
    ('PROD-007', 'Anker 65W GaN Fast Charger', 1190, true, 'SYSTEM', 'SYSTEM'),
    ('PROD-008', 'Ergonomic Mesh Office Chair Pro', 5500, true, 'SYSTEM', 'SYSTEM'),
    ('PROD-009', 'Old Generation Lightning Cable 1m', 150, false, 'SYSTEM', 'SYSTEM') 
    ('PROD-010', 'Apple iPhone 17 Pro 128GB', 39900, true, 'SYSTEM', 'SYSTEM'); 
```

### Insert: `STOCK`
```sql
INSERT INTO STOCK (PRODUCT_ID, AMOUNT, ACTIVE, CREATE_BY, UPDATE_BY)
SELECT PRODUCT_ID, 25, true, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-001'
UNION ALL
SELECT PRODUCT_ID, 40, true, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-002'
UNION ALL
SELECT PRODUCT_ID, 15, true, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-003'
UNION ALL
SELECT PRODUCT_ID, 80, true, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-004'
UNION ALL
SELECT PRODUCT_ID, 50, true, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-005'
UNION ALL
SELECT PRODUCT_ID, 12, true, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-006'
UNION ALL
SELECT PRODUCT_ID, 150, true, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-007'
UNION ALL
SELECT PRODUCT_ID, 8, true, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-008'
UNION ALL
SELECT PRODUCT_ID, 0, false, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-009'
UNION ALL
SELECT PRODUCT_ID, 0, true, 'SYSTEM', 'SYSTEM' FROM PRODUCT WHERE PRODUCT_CODE = 'PROD-010';
```
